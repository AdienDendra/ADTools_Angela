...
class Build:
    def __init__(self,
        ...
        eyebrowCtrl = ac.Control(matchPos=eyebrowJnt,
                                         prefix='eyebrow',
    ...
    # CREATE GROUP CORESPONDENT THE JOINTS
        ...
        au.createParentTransform(listparent=[''], object=eyebrowJnt, matchPos=eyebrowJnt, prefix='eyebrow', suffix='_jnt')
        ...
        au.connectAttrObject(self.eyebrowCtrl, eyebrowJnt)
    ...
    # ==================================================================================================================
        ...
        mc.scaleConstraint(self.headUpCtrl, self.follicleTransformAll[3])
